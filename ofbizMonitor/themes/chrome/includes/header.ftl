...
<head>
    ...
    <#elseif layoutSettings.VT_SHORTCUT_ICON?has_content>    
      <link rel="shortcut icon" href="<@ofbizContentUrl>${layoutSettings.VT_SHORTCUT_ICON.get(0)}</@ofbizContentUrl>" />
    </#if>
    ...
    <#if layoutSettings.VT_JAVASCRIPT?has_content>
        <#list layoutSettings.VT_JAVASCRIPT as javaScript>
            <script language="javascript" src="<@ofbizContentUrl>${javaScript}</@ofbizContentUrl>" type="text/javascript"></script>
        </#list>
    </#if>
    ...
    <ul>
      ...
      <#else>
        ...
        <#if headerImageUrl?exists>
          <li class="logo-area"><a href="${logoLinkURL}"><img alt="${layoutSettings.companyName}" src="<@ofbizContentUrl>${headerImageUrl}</@ofbizContentUrl>"/></a></li>
        </#if>
