          ...
          <td>
            <#if orderReadyToPickInfoList?has_content>
              <form method="post" action="<@ofbizUrl>createPicklistFromOrders</@ofbizUrl>">
                ...
                <input type="text" size="4" name="maxNumberOfOrders" value="9999"/>
            ...
            <td>
              <#if orderReadyToPickInfoList?has_content>
                <form method="post" action="<@ofbizUrl>createPicklistFromOrders</@ofbizUrl>">
                  ...
                  <#if groupName1?has_content>
                    <input type="hidden" name="shipmentMethodTypeId" value="${groupName1}"/>
                  </#if>
                  ...
                  <input type="submit" value="${uiLabelMap.ProductCreatePicklist}"/>
                  <input type="submit" value="Auto ${uiLabelMap.ProductCreatePicklist}" onclick="javascript:this.form.action='autoCreatePicklist'"/>
                </form>
              <#else>
                &nbsp;
              </#if>
              ...
              <#if orderReadyToPickInfoList?has_content>
                <form method="post" action="<@ofbizUrl>printPickSheets</@ofbizUrl>">
                  ...
                  <#else>
                    ...
                    <input type="text" size="4" name="maxNumberOfOrdersToPrint" value="9999"/>
                  </#if>
