...
if (orderId) {
    ...
    if (orderHeader) {
        ...
        //notes = delegator.findList("OrderHeaderNoteView", [orderId : orderId], ["-noteDateTime"], null, false);
        notes = delegator.findList("OrderHeaderNoteView", EntityCondition.makeCondition("orderId", EntityOperator.EQUALS, orderId), null, ["-noteDateTime"], null, false);
        ...
        if ("ORDER_APPROVED".equals(orderHeader.statusId)) {
            ...
            if (!shipment) {
                ...
                context.productStoreShipmentMethList = delegator.findList("ProductStoreShipmentMethView", EntityCondition.makeCondition([productStoreId: productStore.productStoreId]), null, ['sequenceNumber'], null, true);
...
shipGroups = delegator.findList("OrderItemShipGroup", EntityCondition.makeCondition([orderId : orderId]), null, ["shipGroupSeqId"], null, false);
