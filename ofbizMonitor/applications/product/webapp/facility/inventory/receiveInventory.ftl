        ...
        <#if requestParameters.initialSelected?exists && product?has_content>
          <form method="post" action="<@ofbizUrl>receiveSingleInventoryProduct</@ofbizUrl>" name="selectAllForm">
            <table class="basic-table" cellspacing="0">
              ...
              <input type="hidden" name="productId" value="${requestParameters.productId?if_exists}"/><input type="hidden" name="inventoryItemTypeId" value="<#if facility.defaultInventoryItemTypeId?has_content>${facility.defaultInventoryItemTypeId}<#else>NON_SERIAL_INV_ITEM</#if>"/>
              ...
              <tr>
                <td width="14%">&nbsp;</td>
                <#-- Bellyanna - START -->
                <td width="6%" align="right" nowrap="nowrap" class="label">${uiLabelMap.ProductImage}</td>
                <td width="6%">&nbsp;</td>
                <td width="74%">
              ...
              <#--<tr>
                ...
                <td width="6%">&nbsp;</td>
                <td width="74%">-->
                  <input type="hidden" name="ownerPartyId" size="24" value="${facility.ownerPartyId}" /><#--<@htmlTemplate.lookupField formName="selectAllForm" name="ownerPartyId" id="ownerPartyId" fieldFormName="LookupPartyName"/>
                </td>
              </tr>-->
              <tr>
                <td width="14%">&nbsp;</td>
                  ...
                  <select name="partyId">
                    ...
                    <#if supplierPartyIds?has_content>
                      <#list supplierPartyIds as supplierPartyId>
                        <option value="${supplierPartyId}" selected="selected"> <#-- <#if supplierPartyId == parameters.partyId?if_exists> selected="selected" </#if>> -->
              ...
              <tr>
                ...
                <td width="74%">
                  <#if facilityLocations?has_content>
                    <select name="locationSeqId">
                      <#list facilityLocations as productFacilityLocation>
                        ...
                        <#-- Bellyanna - START -->
                        <#if productFacilityLocation.locationSeqId.equals("NoLocation")>
                            <#list freeLocations00 as freeLocation>
                                <option value="${freeLocation}">free - ${freeLocation}</option>
                                <#if (freeLocation_index > 1)><#break></#if>
                            </#list>
                            <option value=""></option>
                            <option style="text-decoration:underline;overbar" value="">Small</option>
                            <#list freeLocations01 as freeLocation>
                                <option value="${freeLocation}">free - ${freeLocation}</option>
                                <#if (freeLocation_index > 1)><#break></#if>
                            </#list>
                        <#else>
                            <option value="${productFacilityLocation.locationSeqId}">${productFacilityLocation.locationSeqId}<#if facilityLocationTypeEnum?exists> - [${facilityLocationTypeEnum.get("description",locale)}]</#if></option>
                            <option value=""></option>
                            <option style="text-decoration:underline;overbar" value="">Small</option>
                            <#list freeLocations01 as freeLocation>
                                <option value="${freeLocation}">free - ${freeLocation}</option>
                        ...
                        <option value=""></option>
                        <option value="NoLocation">NoLocation</option>
                        <#-- Bellyanna - END -->
                      </#list>
                  ...
                  <a href="/catalog/control/EditProductFacilityLocations?productId=${product.productId}" target="_blank" class="buttontext">Add new Location</a> <b>${uiLabelMap.SmallAccClickHere}<b>
                </td>
              </tr>
              <tr>
                <td width="14%">&nbsp;</td>
              ...
              <#--<tr>
                ...
                <td width="74%">-->
                  ...
                  <input type="hidden" name="unitCost" size="10" value="${unitCost}"/>
                <#--</td>
              </tr>-->
              <tr>
                <td colspan="2">&nbsp;</td>
            ...
            <script language="JavaScript" type="text/javascript">
              ...
              document.selectAllForm.quantityAccepted.select();
            </script>
          </form>
                        ...
                        <tr>
                          <td width="45%">
                            ...
                            <#if product.largeImageUrl?has_content>
                                <a href="${product.originalImageUrl}" onclick="window.open(this.href,'','height=480,width=640');return false;"><img alt="${product.productId?if_exists}" src="${product.largeImageUrl}"/></a>
                            </#if>
                            <#-- Bellyanna - END -->
                          </td>
