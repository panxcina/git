...
<#if security.hasEntityPermission("CATALOG", "_VIEW", session)>
  <div class="label"><a href="<@ofbizUrl>productSearchList</@ofbizUrl>" class="buttontext">Product Search List</a></div>
  <br /><br />
  <div class="label"><a href="<@ofbizUrl>importProduct</@ofbizUrl>" class="buttontext">Product Importation</a></div>
  <br /><br />
