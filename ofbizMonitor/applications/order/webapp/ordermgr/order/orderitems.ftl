                                ...
                                <td colspan="7">
                                    <div class="order-item-description">
                                        ...
                                        <#elseif productId?exists>
                                            <a href="/catalog/control/EditProduct?productId=${productId}${externalKeyParam}" class="buttontext" target="_blank">${orderItem.productId?default("N/A")}</a> - ${orderItem.itemDescription?if_exists}
                                        ...
                                        </div><table cellspacing='0'><tr valign="bottom"><td>
                                        <#if orderItemAttributes?has_content>
                                            <ul>
                                            <#list orderItemAttributes as orderItemAttribute>
                                                <li>
                                                    <#if orderItemAttribute.attrName != "SELLER_EBAY_USERNAME">
                                                      ${orderItemAttribute.attrName} : ${orderItemAttribute.attrValue}
                                                      <#if orderItemAttribute.attrName == "eBay Item Number">
                                                        &nbsp;<a href="http://www.ebay.com/itm/ws/eBayISAPI.dll?ViewItem&item=${orderItemAttribute.attrValue}" target="blank" class="smallSubmit">${uiLabelMap.ViewOnEbay}</a>
                                                      </#if>
                                                    </#if>
                                                </li>
                                            </#list>
                                    ...
                                    <#-- Bellyanna - START -->
                                      ...
                                      <a href="http://images.bellyanna.com/${parentSku}/${childSku}/${childSku}.jpg" onclick="window.open(this.href,'','height=480,width=640');return false;"><img alt="${product.productId?if_exists}" height="160" src="http://images.bellyanna.com/${parentSku}/${childSku}/${childSku}.jpg"/></a>
                                    </td></tr></table>
                                    <#-- Bellyanna - END -->
                            ...
                            <#list orderItemShipGrpInvResList as orderItemShipGrpInvRes>
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        ...
                                        <#assign inventoryLocation = Static["org.ofbiz.entity.util.EntityUtil"].getFirst(delegator.findByAnd("InventoryItem", Static["org.ofbiz.base.util.UtilMisc"].toMap("inventoryItemId", orderItemShipGrpInvRes.inventoryItemId), null, false))><#if inventoryLocation.locationSeqId?has_content>&nbsp;(${inventoryLocation.locationSeqId})</#if>
