            ...
            <div>
              ...
              <#if partyId?exists>
                ...
                <#if !orderHeader.salesChannelEnumId?has_content>
                  <font color="red">${uiLabelMap.NoSalesChannelData}!</font>
            ...
            <td valign="top" width="80%">
              <#if contactMech.contactMechTypeId == "POSTAL_ADDRESS">
                ...
                <#if postalAddress?has_content>
                  ...
                  <a href="<@ofbizUrl>orderShippingLabel.pdf?orderId=${orderId}</@ofbizUrl>" target="_blank" class="buttontext">${uiLabelMap.Print} ${uiLabelMap.ShippingLabel}</a>
                </#if>
              <#elseif contactMech.contactMechTypeId == "TELECOM_NUMBER">
              ...
              <#elseif contactMech.contactMechTypeId == "EBAY_USER_ID">
                <div>
                  <#if contactMech.infoString?has_content>${contactMech.infoString}</#if>
                </div>
              <#else>
                <div>
