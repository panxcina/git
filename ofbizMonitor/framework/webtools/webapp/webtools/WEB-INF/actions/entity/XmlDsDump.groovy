...
if ("Product1".equals(preConfiguredSetName)) {
    ...
    //passedEntityNames.add("ProductKeyword");
    } else if ("Migration".equals(preConfiguredSetName)) {
    passedEntityNames = new LinkedHashSet();
    passedEntityNames.add("ContactMech");
    passedEntityNames.add("EbayEmailTemplate");
    passedEntityNames.add("EntityAuditLog");
    passedEntityNames.add("EntitySyncRemove");
    passedEntityNames.add("FacilityLocation");
    passedEntityNames.add("FacilityParty");
    passedEntityNames.add("InventoryItem");
    passedEntityNames.add("InventoryItemDetail");
    passedEntityNames.add("InventoryItemStatus");
    passedEntityNames.add("InventoryItemVariance");
    passedEntityNames.add("Invoice");
    passedEntityNames.add("InvoiceContactMech");
    passedEntityNames.add("InvoiceItem");
    passedEntityNames.add("InvoiceRole");
    passedEntityNames.add("InvoiceStatus");
    passedEntityNames.add("ItemIssuance");
    passedEntityNames.add("ItemIssuanceRole");
    passedEntityNames.add("NoteData");
    passedEntityNames.add("OrderAdjustment");
    passedEntityNames.add("OrderAdjustmentBilling");
    passedEntityNames.add("OrderAttribute");
    passedEntityNames.add("OrderContactMech");
    passedEntityNames.add("OrderHeader");
    passedEntityNames.add("OrderHeaderNote");
    passedEntityNames.add("OrderItem");
    passedEntityNames.add("OrderItemAttribute");
    passedEntityNames.add("OrderItemBilling");
    passedEntityNames.add("OrderItemChange");
    passedEntityNames.add("OrderItemShipGroup");
    passedEntityNames.add("OrderItemShipGroupAssoc");
    passedEntityNames.add("OrderItemShipGrpInvRes");
    passedEntityNames.add("OrderPaymentPreference");
    passedEntityNames.add("OrderRole");
    passedEntityNames.add("OrderShipment");
    passedEntityNames.add("OrderStatus");
    passedEntityNames.add("Party");
    passedEntityNames.add("PartyAcctgPreference");
    passedEntityNames.add("PartyContactMech");
    passedEntityNames.add("PartyContactMechPurpose");
    passedEntityNames.add("PartyDataSource");
    passedEntityNames.add("PartyGroup");
    passedEntityNames.add("PartyRole");
    passedEntityNames.add("PartyStatus");
    passedEntityNames.add("Payment");
    passedEntityNames.add("PaymentApplication");
    passedEntityNames.add("PaymentGatewayResponse");
    passedEntityNames.add("PaymentMethod");
    passedEntityNames.add("Person");
    passedEntityNames.add("PhysicalInventory");
    passedEntityNames.add("Picklist");
    passedEntityNames.add("PicklistBin");
    passedEntityNames.add("PicklistItem");
    passedEntityNames.add("PicklistRole");
    passedEntityNames.add("PicklistStatusHistory");
    passedEntityNames.add("PostalAddress");
    passedEntityNames.add("Product");
    passedEntityNames.add("ProductAverageCost");
    passedEntityNames.add("ProductFacility");
    passedEntityNames.add("ProductFacilityLocation");
    passedEntityNames.add("ProductItemSpecific");
    passedEntityNames.add("ProductPictureExternal");
    passedEntityNames.add("ProductPrice");
    passedEntityNames.add("Refund");
    passedEntityNames.add("SequenceValueItem");
    passedEntityNames.add("Shipment");
    passedEntityNames.add("ShipmentGeoEstimate");
    passedEntityNames.add("ShipmentItem");
    passedEntityNames.add("ShipmentItemBilling");
    passedEntityNames.add("ShipmentPackage");
    passedEntityNames.add("ShipmentPackageContent");
    passedEntityNames.add("ShipmentPackageRouteSeg");
    passedEntityNames.add("ShipmentReceipt");
    passedEntityNames.add("ShipmentRouteSegment");
    passedEntityNames.add("ShipmentStatus");
    passedEntityNames.add("TelecomNumber");
    passedEntityNames.add("UomConversionDated");
    passedEntityNames.add("UserLogin");
    passedEntityNames.add("UserLoginSecurityGroup");
    passedEntityNames.add("Visit");
    passedEntityNames.add("Visitor");
        ...
        if (outpath) {
            ...
            if (outdir.isDirectory() && outdir.canWrite()) {
                passedEntityNames.each { curEntityName ->
                    ...
                    fileName = curEntityName;   //fileName = fileName + curEntityName;
