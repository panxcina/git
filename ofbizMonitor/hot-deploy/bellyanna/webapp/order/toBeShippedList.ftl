      ...
      <form action="<@ofbizUrl>sendToBeShippedEbayMessage</@ofbizUrl>" method="post" name="expressList">
        ...
        <input type=hidden name="productStoreId" value="${expressList.productStoreId}"/>
      	<tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <td>
                <#if delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", expressList.orderId, "attrName", "OSA_EMAIL_SENT"), false)?has_content>
                <#assign orderAttribute = delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", expressList.orderId, "attrName", "OSA_EMAIL_SENT"), false)>
                <#if (orderAttribute.attrValue?number > 0)>Sent - ${orderAttribute.attrValue}</#if>
                </#if>
            </td>
      ...
      <form action="<@ofbizUrl>sendToBeShippedEbayMessage</@ofbizUrl>" method="post" name="epacketList">
        ...
        <input type=hidden name="productStoreId" value="${epacketList.productStoreId}"/>
      	<tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <td>
                <#if delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", epacketList.orderId, "attrName", "OSA_EMAIL_SENT"), false)?has_content>
                <#assign orderAttribute = delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", epacketList.orderId, "attrName", "OSA_EMAIL_SENT"), false)>
                <#if (orderAttribute.attrValue?number > 0)>Sent - ${orderAttribute.attrValue}</#if>
                </#if>
            </td>
            <td><input type="submit" value="Process" class="smallSubmit"/></td>
      ...
      <form action="<@ofbizUrl>sendToBeShippedEbayMessage</@ofbizUrl>" method="post" name="standardList">
        ...
        <input type=hidden name="productStoreId" value="${standardList.productStoreId}"/>
      	<tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
            ...
            <td>
                <#if delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", standardList.orderId, "attrName", "OSA_EMAIL_SENT"), false)?has_content>
                <#assign orderAttribute = delegator.findOne("OrderAttribute", Static["org.ofbiz.base.util.UtilMisc"].toMap("orderId", standardList.orderId, "attrName", "OSA_EMAIL_SENT"), false)>
                <#if (orderAttribute.attrValue?number > 0)>Sent - ${orderAttribute.attrValue}</#if>
                </#if>
            </td>
            <td><input type="submit" value="Process" class="smallSubmit"/></td>
