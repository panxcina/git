...
<div id="taskDetailCondition4" class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            <li class="h3"><b>Rival Item ID is missing (G1 products) &nbsp; - &nbsp; Condition: G1 + Crawl is FALSE or blank</b></li>
        </ul>
        <br class="clear"/>
    </div>
    <div class="screenlet-body" align="center">
<form name='taskDetailCondition4' method="post" action="<@ofbizUrl>taskDetailCondition4</@ofbizUrl>">
