    ...
    <div class="screenlet-body" align="left">
        ...
        <table class="border">
            ...
            <tr class="border">
                ...
                <td align="left" class="border" rowspan="11" style="vertical-align:top" id="TASKRESULT">Click the Sub Category to show Project List here</td>
            </tr>
            <tr class="border">
            ...
            <tr class="border">
                ...
                <td class="border" style="vertical-align:middle;cursor:hand; cursor:pointer;" id="21000" onclick="changeTaskResult(this.id, '21000' ,'DEPARTMENT')">青铜部</td>
            </tr>
            <tr class="border">
                <td class="border" style="vertical-align:middle;cursor:hand; cursor:pointer;" id="22000" onclick="changeTaskResult(this.id, '22000' ,'DEPARTMENT')">白银部</td>
            </tr>
            <tr class="border">
                <td class="border" style="vertical-align:middle;cursor:hand; cursor:pointer;" id="23000" onclick="changeTaskResult(this.id, '23000' ,'DEPARTMENT')">黄金部</td>
            </tr>
            <tr class="border">
