                    ...
                    <td>
                        <select name="businessTreeId">
                            ...
                            <!--<#list profileList as profileList>
                                <option value="${profileList.parent.businessTreeId}|PROFILE" <#if mercuryHeader??><#if mercuryHeader.businessTreeId==profileList.parent.businessTreeId && mercuryHeader.businessTreeType=="PROFILE">SELECTED</#if></#if>>${profileList.parent.title}</option>
