...
<body>
    ...
    <script src="/images/project_demo/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="/images/project_demo/js/plugins/flot/curvedLines.js"></script>
    ...
    <!-- Jvectormap -->
    <script src="/images/project_demo/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/images/project_demo/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
