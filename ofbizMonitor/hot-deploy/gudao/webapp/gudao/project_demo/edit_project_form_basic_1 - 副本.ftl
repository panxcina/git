            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="ibox-content">
                            <form  action="<@ofbizUrl><#if mercuryHeader??>updateGudaoProject<#else>createGudaoProject</#if></@ofbizUrl>" method="post" name="editGudaoProject" id="editGudaoProjectForm" class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Project Name</label>
                                    ...
                                    <div class="col-sm-10"><input type="text"  name="title" class="form-control" value="<#if mercuryHeader??>${mercuryHeader.title!}</#if>"></div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Category</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control m-b" name="businessTreeId">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-primary" value="<#if mercuryHeader??>Update<#else>Create</#if>" type="submit"><#if mercuryHeader??>Update<#else>Create</#if></button>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tr>
                                    ...
                                    <th data-toggle="true">TASK NAME</th>
                                    <th>ASSIGNED TO</th>
                                    <th>STATUS</th>
                                        ...
                                        <#if mercuryItem.statusId == "COMPLETED">
                                            ...
                                            <#else>
                                                <form action="<@ofbizUrl>updateMercuryItemStatus</@ofbizUrl>" method="post" name="updateMercuryItemStatus_${mercuryHeader.mercuryId}_${mercuryItem.sequenceId}">
                                                                ...
                                                                <button class="btn btn-primary" type="submit"  value="<#if mercuryItem.statusId == "IN_PROGRESS">Complete<#else>Work On it</#if>"><#if mercuryItem.statusId == "IN_PROGRESS">Complete<#else>Work On it</#if></button>
                                                 </form>
                                        </#if>
                                    </td>
                                                    ...
                                                    <!--<div class="modal-body">-->
                                                        <div class="modal-body col-md-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control datetimepicker" name="startDate" value="" id="edit_startDate_${mercuryHeader.mercuryId}_${mercuryItem.sequenceId}" placeholder="${mercuryItem.startDate!}"/>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="ETA">ETA</label>
                                                                <input type="text"  name="completeDateEta" class="form-control datetimepicker1" value="" id="edit_completeDateEta_${mercuryHeader.mercuryId}_${mercuryItem.sequenceId}" placeholder="<#if mercuryItem.statusId == "COMPLETED">${mercuryItem.completedDate!}<#else><#if mercuryItem.overdue><font color=red></#if><#if mercuryItem.completeDateEta?date!=dummyDate?date>${mercuryItem.completeDateEta!?date}</#if><#if mercuryItem.overdue></font></#if></#if>"/>
